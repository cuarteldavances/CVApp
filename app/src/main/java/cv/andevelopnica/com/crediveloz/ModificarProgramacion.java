...
public class ModificarProgramacion extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modificar_programacion);
    ...
    public void returnHome() {
        ...
        Intent home_intent = new Intent(getApplicationContext(),
                ProgramacionActvity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
